...
<head>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#summary_from_sales_date').jdPicker();
            $('#summary_to_sales_date').jdPicker();
        ...
        function sales_report_fn() {
            window.open("sales_report.php?salesman=" + $('#salesman').val() + "&from_sales_date=" + $('#from_sales_date').val() + "&to_sales_date=" + $('#to_sales_date').val(), "myNewWinsr", "width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes");

        }
         function summary_sales_report_fn() {
            window.open("summary_sales_report.php?cashier=" + $('#cashier').val() + "&from_sales_date=" + $('#summary_from_sales_date').val() + "&to_sales_date=" + $('#summary_to_sales_date').val(), "myNewWinsr", "width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes");
        ...
        function stock_sales_report_fn() {
            window.open("sales_stock_report.php?sales_from=" + $('#from_stock_sales_date').val() + "&sales_to=" + $('#to_stock_sales_date').val(), "myNewWinsr", "width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes");

        }
        
        
         function stock_report_fn() {
            window.open("stock_report.php?from_stock_date=" + $('#from_sales_purchase_date').val() + "&to_stock_date=" + $('#to_sales_purchase_date').val(), "myNewWinsr", "width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes");

        }
        
        function stock_report_by_cat(){
            window.open("stock_report_by_cat.php", "myNewWinsr", "width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no,scrollbars=yes");
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                              <form action="sales_report.php" method="post" name="form1" id="form1" name="sales_report"
                                 ...
                                 <tr>
                                    ...
                                    <td><strong>Sales Report (Summary) </strong></td>
                                    <td>Cashier </td>
                                     <td><select class="js-example-basic-multiple round default-width-input" name="salesman" id="cashier" placeholder="Select Cashier" >
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>From</td>
                                    <td><input name="from_sales_date" type="text" id="summary_from_sales_date"
                                               style="width:80px;"></td>
                                    <td>To</td>
                                    <td><input name="to_sales_date" type="text" id="summary_to_sales_date" style="width:80px;">
                                    </td>
                                    <td><input name="submit" type="button" value="Show" onClick='summary_sales_report_fn();'>
                                    </td>
                            ...
                            <form action="sales_report.php" method="post" name="form1" id="form1" name="sales_report"
                                 ...
                                 <tr>
                                    ...
                                    <td><strong>Sales Report (detailed) </strong></td>
                                    <td>Cashier </td>
                                     <td><select class="js-example-basic-multiple round default-width-input" name="salesman" id="salesman" placeholder="Select Cashier" >
                            ...
                            <tr>
                             ...
                             <form action="sales_purchase_report.php" method="post" name="sales_purchase_report"  target="_blank">
                                <tr>
                                    <td><strong>Stock Report  By Category</strong></td>
                                    <td>From</td>
                                    <td><input name="from_sales_purchase_date" type="text" id=""
                                               style="width:80px;"></td>
                                    <td>To</td>
                                    <td><input name="to_sales_purchase_date" type="text" id=""
                                               style="width:80px;"></td>
                                    <td><input name="submit" type="button" value="Show"
                                               onClick='stock_report_by_cat();'></td>
                                </tr>
                            </form>
<!--
