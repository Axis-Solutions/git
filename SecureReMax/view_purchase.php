                    ...
                    <table>
                        ...
                        <form name="deletefiles" action="delete.php" method="post">
                            ...
                            <table>
                                ...
                                $SQL = "SELECT DISTINCT(stock_id) FROM  stock_entries";

                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                    $SQL = "SELECT DISTINCT(stock_id) FROM  stock_entries WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' OR type LIKE '%" . $_POST['searchtxt'] . "%'";
                                ...
                                */
                                ...
                                $sql = "SELECT * FROM stock_entries where status='Purchased' ORDER BY Date_Created desc LIMIT $start, $limit  ";

                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                    $sql = "SELECT DISTINCT(stock_id) FROM stock_entries WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR Date_Created LIKE '%" . $_POST['searchtxt'] . "%' OR type LIKE '%" . $_POST['searchtxt'] . "%' and status='Purchased' ORDER BY Date_Created desc LIMIT $start, $limit";
