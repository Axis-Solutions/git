...
var BaseFormWizard = function() {
    ...
    var initWizardValidation = function(){
        ...
        var $validator1 = $form1.validate({
            ...
            rules: {
                'validation-classic-custnum': {
                    required: true,
                    minlength: 2
                },
                'validation-classic-custname': {
                    required: true,
                    minlength: 2
                },
                'validation-classic-address': {
                    required: true,
                    minlength: 6
                },
            ...
            messages: {
                ...
                'validation-classic-address': {
                    required: 'Please specify your customer ship to address',
                    minlength: 'Your customer name must consist of at least 2 characters'
                },
                'validation-classic-email': 'Enter a valid email'
