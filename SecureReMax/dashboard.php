...
<div id="header-with-tabs">
    ...
    <div class="page-full-width cf">
       ...
       <?php 
       $co_det = get_co_details();
        @$_SESSION['logo'] = $co_det[0]["log"];
        ?>
                ...
                <div class="content-module-main cf">
                    ...
                    <table style="width:350px; float:left;" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td align="left"><?php  echo $count = table_counter("stock_details"); ?>&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="left"><?php echo $count = table_counter("stock_sales"); ?></td>
                        </tr>
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="left"><?php echo $count = table_counter("supplier_details"); ?></td>
                        </tr>
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="left"><?php echo $count = table_counter("customer_details"); ?></td>
                        </tr>
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td align="left">&nbsp;</td>
