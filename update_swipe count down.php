...
<div id="content">
 ...
 <p>
                        <label>Swipe Count Down</label>
                                                  
                         <select class="round full-width-input" name="seconds" id="seconds" data-placeholder="Choose Payment mode">
                                                <option value="<?php echo $det [0]["email"] ; ?>"></option>
