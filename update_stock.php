...
require 'db/var.php';
@$sID = $_GET["sid"];
$this_prod = get_prod_details($sID );
...
<html lang="en">
    ...
    <body>
        ...
        <div id="content">
                                ...
                                <table class="form" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td><input name="stockid" type="text" id="stockid" placeholder="Enter Stock Code"  maxlength="200"
                                                   ...
                                                   value="<?php echo $this_prod[0]["stock_id"] ?>"/></td>

                                        <td><span class="man">*</span>Name:</td>
                                        <td><input name="name" placeholder="ENTER STOCK NAME" type="text" id="name"
                                                   maxlength="200"  value="<?php echo $this_prod[0]["stock_name"] ?>" class="round default-width-input"
                                                   /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="cost" placeholder="ENTER COST PRICE" type="text" id="cost"
                                                   maxlength="200" class="round default-width-input" value="<?php echo $this_prod[0]["company_price"] ?>"
                                                   onkeypress="return numbersonly(event)"
                                                   /></td>

                                        <td><span class="man">*</span>Sell:</td>
                                        <td><input name="sell" placeholder="ENTER SELLING PRICE" type="text" id="sell"
                                                   maxlength="200" class="round default-width-input" value="<?php echo $this_prod[0]["selling_price"]; ?>"
                                                   onkeypress="return numbersonly(event)"
                                                  /></td>
                                    ...
                                    <tr>
                                        <td>Qty Avail:</td>
                                        <td><input name="qty" placeholder="Qty available" readonly="true" type="number" id="qty"
                                                   maxlength="200" class="round default-width-input" value="<?php echo $this_prod[0]["stock_quatity"] ?>"
                                                   /></td>

                                        <td>Category:</td>
                                        <td><select class="js-example-basic-multiple round default-width-input" value="<?php echo $this_prod[0]["category"] ?>" name="category" id="categ" placeholder="Provide Product Tac Code" >
                                    ...
                                    <tr>
                                        ...
                                        <td>  <select class="js-example-basic-multiple round default-width-input" value="<?php echo $this_prod[0]["Tax_Code"] ?>" name="tax_code" placeholder="Provide Product Tac Code" >
                                         ...
                                         <td>UOM:</td>
                                        <td> <select class="js-example-basic-multiple round default-width-input" value="<?php echo $this_prod[0]["uom"] ?>" name="UOM" placeholder="Provide Product Tac Code" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="button round blue image-right ic-add text-upper" type="submit"
                                                   name="Submit" id="btn_updtstk" value="Update ">
                                            (Control + S)
            ...
            $("#btn_updtstk").click(function(e){
                e.preventDefault();
                var id = '<?php echo $sID; ?>';
                $.post("engines/edit_stock.php?id="+id,$("#form1").serialize(),function(response){
