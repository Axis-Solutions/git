...
function sendSocketRequest($XmlString, $Socket_Request, $caseNum, $rec_no, $AmntPaid, $random) {
...
$socketResponse = sendSocketRequest($xmlString_trans, array('HostName' => 'localhost', 'Port' => '23001'), $case, $rec_no, $AmntPaid, $random);
