...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'admin') { // if session variable "username" does not exist.
    ...
    if (isset($_GET['from_stock_date']) && isset($_GET['to_stock_date']) && $_GET['from_stock_date'] != '' && $_GET['to_stock_date'] != '') {
                            ...
                            <td height="20">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="393">&nbsp;<?php echo $_GET['from_stock_date']; ?></td>
                                        <td width="41"><strong>To</strong></td>
                                        <td width="116">&nbsp;<?php echo $_GET['to_stock_date']; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = $db->query("SELECT * FROM stock_details where status ='active' order by stock_name asc");
