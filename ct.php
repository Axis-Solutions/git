...
<span id="countdown-2">60 seconds</span>
<span id="countdown-3">120 seconds</span>
<script type="text/javascript">
    ...
    setTimeout("countdown('countdown-2',"+secs+")", 1000);
	 secs       = parseInt(document.getElementById('countdown-3').innerHTML,10);
    setTimeout("countdown('countdown-3',"+secs+")", 1000);
