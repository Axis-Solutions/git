...
require 'db/var.php';
  ...
  $rec_no = substr($cop_det[0]["name"],0,3).date("YmdHis");  
...
<html lang="en">
    ...
    <body>
      ...
      <input type = "hidden" id = "rec_no" name = "<?php echo $rec_no;?>" value ="<?php echo $rec_no;?>" >
                                ...
                                <table class="form">
                                 ...
                                 <div id="response" class="row SwipePay">
 <div class="col-md-6">
                                        <div class="white-box">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form>
                                                                       ...
                                                                       <div class="response"> ..........SWIPE CARD AND ENTER PIN......... </div> <br>
                                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10 BtnSwipePayment btnadd button ">Proceed...
                                 </button>
                   </form>
                                                </div>
                                            </div>
             ...
             totals_array.pop(line_tot);
                 ...
                 $("#payable_amount").val(payable_amount);
                  ...
                  $("#payment_mode").change(function () {
                    ...
                    if (payable_amnt != "")
                    {
                        ...
                        else if (mode === "credit" || mode  === "swipe") {
                            $("#payment").val(payable_amnt);
                ...
                //if payment mode is partly cash
                  $("#payment").on("change", function () {
                   ...
                   alert("If mode is partly cash you can only pay amount less than total cost of supply. If your cash amount is greater than total supply cost. Change mode to Cash."); 
                   $("#balance").val("");
                   $("#payment").val("");
                }
                }
               ...
               $(".BtnSwipePayment").click(function (ev)
              {
				  ...
				  // rec_no: $("#rec_no").val();
				  //alert($("#rec_no").val());
				 // alert($("#payable_amount").val()*100);
				  
                    $(".swipe_resp").slideDown("slow");
                        $.get("engines/eft.php?case=1",
                           {                             
							  rec_no: $("#rec_no").val(),
							
							  AmntPaid: $("#payable_amount").val()*100  
